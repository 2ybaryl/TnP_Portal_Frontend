...
function App() {
  return (
    ...
    <Routes>
                 ...
                 <Route exact path='/studentLogin' element={<Slogin/>}></Route>
                 <Route exact path='/studentRegister' element={<Sregister/>}></Route>
                 <Route exact path='/teacherLogin' element={<Tlogin />}></Route>
